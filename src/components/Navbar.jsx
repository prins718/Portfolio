    ...
    <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'glass py-4 shadow-lg' : 'bg-transparent py-6'}`}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            ...
            <a href="/Resume_Prins_Desai.pdf" download="Resume_Prins_Desai.pdf" className="px-4 py-2 bg-blue-600/20 text-blue-400 border border-blue-500/50 hover:bg-blue-600 hover:text-white rounded-full transition-all duration-300 font-medium flex items-center gap-2">
      ...
      {isOpen && (
        <div className="md:hidden glass absolute top-full left-0 w-full flex flex-col items-center py-4 space-y-4 border-t border-gray-800">
          ...
          <a href="/Resume_Prins_Desai.pdf" download="Resume_Prins_Desai.pdf" className="text-blue-400 font-medium w-full text-center py-2 flex items-center justify-center gap-2">
