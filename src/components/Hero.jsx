    ...
    <section id="about" className="min-h-[80vh] flex flex-col justify-center animate-fade-in-up relative z-10">
      <div className="max-w-4xl relative pointer-events-auto">
        ...
        <div className="flex gap-4 items-center">
          ...
          <a href="/Resume_Prins_Desai.pdf" download="Resume_Prins_Desai.pdf" className="ml-2 px-6 py-3 bg-gray-800 hover:bg-gray-700 rounded-full font-semibold transition-transform hover:-translate-y-1 border border-gray-700 hover:border-blue-500 shadow-lg flex items-center gap-2 text-white">
            <Download size={20} />
